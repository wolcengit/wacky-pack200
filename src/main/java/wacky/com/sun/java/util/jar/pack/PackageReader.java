...
import wacky.com.sun.java.util.jar.pack.ConstantPool.*;
import wacky.com.sun.java.util.jar.pack.Package.Class;
import wacky.com.sun.java.util.jar.pack.Package.File;
import wacky.com.sun.java.util.jar.pack.Package.InnerClass;
...
class PackageReader extends BandStructure {
    ...
    private void readAttrBands(Attribute.Layout.Element[] elems,
