...
package wacky.com.sun.java.util.jar.pack;

import wacky.com.sun.java.util.jar.pack.ConstantPool.Entry;
import wacky.com.sun.java.util.jar.pack.ConstantPool.Index;

import java.io.ByteArrayOutputStream;
import java.io.IOException;
import java.util.*;

import static wacky.com.sun.java.util.jar.pack.Constants.*;
...
class Attribute implements Comparable<Attribute> {
            ...
            switch (layout.charAt(i++)) {
                ...
                case 'K':  // reference_type: constant_ref
                    ...
                    switch (layout.charAt(i++)) {
                        ...
                        case 'S':
                            ...
                            break;
                        case 'Q':
                            e.refKind = CONSTANT_FieldSpecific;
                            break;

                        // new in 1.7:
                        case 'M':
                            e.refKind = CONSTANT_MethodHandle;
                            break;
                        case 'T':
                            e.refKind = CONSTANT_MethodType;
                            break;
                        case 'L':
                            e.refKind = CONSTANT_LoadableValue;
                            break;
                        default: {
                            i = -i;
                            continue;
                ...
                case 'R': // schema_ref
                    ...
                    switch (layout.charAt(i++)) {
                        ...
                        // new in 1.7:
                        case 'Y':
                            e.refKind = CONSTANT_InvokeDynamic;
                            break;
                        case 'B':
                            e.refKind = CONSTANT_BootstrapMethod;
                            break;
                        case 'N':
                            e.refKind = CONSTANT_AnyMember;
                            break;
    ...
    static int parseUsing(Layout.Element[] elems, Holder holder,
                          byte[] bytes, int pos, int len, ValueStream out) {
        int prevBCI = 0;
        int prevRBCI = 0;
        int end = pos + len;
    ...
    static void unparseUsing(Layout.Element[] elems, Object[] fixups,
