...
import wacky.com.sun.java.util.jar.pack.Package.Class.Field;
...
class BandStructure {
    ...
    private Attribute.Layout predefineAttribute(int index, int ctype, Band[] ab,
    ...
    private Attribute.Layout predefineAttribute(int index,
    ...
    private Band[] makeNewAttributeBands(String pfx, Attribute.Layout def,
                                         MultiBand addHere) {
    ...
    private void makeNewAttributeBands(String pfx, Attribute.Layout.Element[] elems,
                                       MultiBand ab) {
        for (int i = 0; i < elems.length; i++) {
