 ...
 * techniques.
 * 
 * Unless otherwise noted, passing a <strong>null</strong> argument to a constructor or
...
public abstract class Pack200 {
     ...
     * <ul>
     * <li>If the system property <strong>java.util.jar.Pack200.Packer</strong>
     * is defined, then the value is taken to be the fully-qualified name
     * of a concrete implementation class, which must implement Packer.
     * This class is loaded and instantiated.  If this process fails
     * then an unspecified error is thrown.</li>
     *
     ...
     * <ul>
     * <li>If the system property <strong>java.util.jar.Pack200.Unpacker</strong>
     ...
     * is instantiated, and the result is returned.</li>
     * </ul>
     *
     * Note:  The returned object is not guaranteed to operate
     * correctly if multiple threads use it at the same time.
     ...
     * 
     * Note: Unless otherwise noted, passing a <strong>null</strong> argument to a
    ...
    public interface Packer {
         ...
         * with <strong>com.</strong> or a similar prefix.
         * All property names beginning with <strong>pack.</strong> and
         * <strong>unpack.</strong> are reserved for use by this API.
         * 
         ...
         * no side-effects.
         *
         * <b>WARNING:</b> This method is omitted from the interface
     ...
     * "<strong>PACK200</strong>" as a zip file comment.
        ...
        try {
            ...
            if (impl == null) {
                if (PACK_PROVIDER.equals(prop)) {
                    impl = wacky.com.sun.java.util.jar.pack.PackerImpl.class;
                } else {
                    impl = wacky.com.sun.java.util.jar.pack.UnpackerImpl.class;
                }
            }
